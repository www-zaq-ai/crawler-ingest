...
Uses markitdown[docx] for conversion.
...
try:
    ...
    print("markitdown is not installed. Run: pip install 'markitdown[docx]'")
    sys.exit(1)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Convert .docx files to markdown (markitdown).",
